                        ...
                        <form class="form" action="signup.php" method="post" >
                            <div id="signin-input">
                                ...
                                ?>">
                                    ...
                                    <input id="nome" name="nome" type="text check" cl placeholder="Nome Completo" class="form-control">
                                ...
                                ?>">
                                    ...
                                    <input id="email" name="email" type="email" class="form-control" placeholder="E-mail" aria-label="Amount (to the nearest dollar)">
                                    <span class="icone"><i class="fas fa-check"></i></span> 
                                    <span class="icone"><i class="fas fa-times"></i></span>
                                </div>
                                <div class="input-group <?php
